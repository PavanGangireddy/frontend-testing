...
export const LoginButton = styled(Button)`
   ${tw`bg-brightBlue w-full h-40px mt-24px rounded-4px`}
`
...
export const Footer = styled.div`
   ${tw`flex flex-col mt-8px items-center`}
`

export const ForgotPassword = styled(Typo14BrightBlueHKGroteskRegular)`
...
export const SignUpLinkLabelText = styled(Typo14SteelHKGroteskRegular)`
   ${tw`
        mt-24px
    `}
`
