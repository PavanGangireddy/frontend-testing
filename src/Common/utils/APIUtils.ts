...
export const displayApiError = (apiError: any, showAlert = false) => {
   let description = ''
   let errorConstant = ''
   let title: string = I18n.t('common.errorViewTitle')
      ...
      try {
         ...
         if (parsedError !== undefined && parsedError !== null) {
            if (
               ...
               title = I18n.t('common.errorViewTitle')
               description = I18n.t('common.errorViewDescription')
            }
            ...
            if (parsedError.http_status_code) {
               ...
               if (
                  ...
                  description = I18n.t('common.internetConnection')
               }
            }
         }
      } catch (e) {
...
export const networkCallWithApisauce = (store: any) => async (
   ...
   try {
      ...
      if (isAccessTokenExpired) {
         ...
         await store.refreshAuthTokensAPI(request, redirectToLearningLogin)
