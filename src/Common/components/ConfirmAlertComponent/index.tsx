            ...
            <Container>
               ...
               <ButtonsContainer>
                  <NoButton
                     ...
                     variant={NoButton.variants.primary}
                     size={NoButton.sizes.small}
                  >
                     {t('common:common.confirmationAlert.no')}
                  </NoButton>
                  <YesButton
                     css={yesButtonCSS}
                     onClick={this.onClickYes}
                     variant={YesButton.variants.primary}
                     size={YesButton.sizes.small}
                  >
                     {t('common:common.confirmationAlert.yes')}
                  </YesButton>
               </ButtonsContainer>
            </Container>
         </MainContainer>
